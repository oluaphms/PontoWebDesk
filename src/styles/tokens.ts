...
export const uiTokens = {
  ...
  surface: {
    ...
    card: 'bg-surface border border-border shadow-card rounded-2xl',
    cardRaised: 'bg-surface-raised border border-border shadow-elevated rounded-2xl',
  ...
  input:
    'w-full rounded-lg border border-border-strong bg-surface px-3 py-2.5 text-sm text-foreground placeholder:text-foreground-disabled shadow-sm hover:bg-surface-sunken hover:border-slate-300 focus:outline-none focus:ring-2 focus:ring-brand focus:border-primary disabled:opacity-55 disabled:cursor-not-allowed disabled:bg-surface-muted',
