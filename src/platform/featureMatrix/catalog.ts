 ...
 * Avaliação vive em `FeatureMatrix` (Flag + License).
 */
import type { FeatureMatrixEntry, ProductFeature } from '../types';
...
export const FEATURE_MATRIX_CATALOG: readonly FeatureMatrixEntry[] = [
  ...
  },
  {
    id: 'whatsapp',
    label: 'WhatsApp',
    description: 'Notificações / canais WhatsApp (estrutura; sem gate de UI).',
  },
  {
    id: 'ai',
  ...
  },
  {
    id: 'realtime',
    label: 'Realtime',
    description: 'Atualizações em tempo real / coordenador.',
  },
  {
    id: 'biometrics',
    label: 'Biometria',
    description: 'Captura biométrica / facial (estrutura; sem gate de UI).',
  },
  {
    id: 'reports',
    label: 'Relatórios',
