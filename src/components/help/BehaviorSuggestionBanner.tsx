...
export const BehaviorSuggestionBanner: React.FC = () => {
  ...
  return (
    <div className="mx-4 md:mx-6 lg:mx-8 mb-2 rounded-xl border border-violet-200/80 dark:border-violet-900/50 bg-violet-50/90 dark:bg-violet-950/30 px-4 py-2 flex items-center gap-2 text-sm text-slate-700 dark:text-slate-300">
