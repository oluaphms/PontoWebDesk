...
call "%LIB%" check_port_free_or_ours 3000
if errorlevel 1 ( pause & exit /b 1 )
call "%LIB%" check_port_free_or_ours 3010
if errorlevel 1 ( pause & exit /b 1 )
...
call "%LIB%" ok "API respondendo em http://localhost:3000/api/health"
...
if errorlevel 1 (
  call "%LIB%" err "Frontend nao respondeu em http://localhost:3010"
  call "%LIB%" offer_logs
  pause
  exit /b 1
)
call "%LIB%" ok "Frontend respondendo em http://localhost:3010"
...
echo ====================================================
echo.
echo Navegador aberto em http://localhost:3010
echo.
