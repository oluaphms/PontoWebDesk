...
if (!name) {
  console.error('Uso: node scripts/generate-service.mjs <service-name>');
  process.exit(1);
}
...
if (fs.existsSync(file)) {
  console.error(`[SCAFFOLD] service já existe: src/services/${name}.ts`);
  process.exit(1);
}
...
console.info(`[SCAFFOLD] service generated: src/services/${name}.ts`);
