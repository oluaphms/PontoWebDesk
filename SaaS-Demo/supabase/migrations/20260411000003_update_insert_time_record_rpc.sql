-- Atualizar RPC para incluir p_manual_reason
-- Esta migration garante que o RPC tenha o parâmetro p_manual_reason
...
CREATE FUNCTION public.insert_time_record_for_user(
  p_user_id TEXT,
  p_company_id TEXT,
  p_type TEXT,
