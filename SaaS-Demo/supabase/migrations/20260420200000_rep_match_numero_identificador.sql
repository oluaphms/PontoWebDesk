-- Batidas do REP enviam matrícula/crachá no campo matricula; no cadastro isso pode estar em
-- users.numero_identificador (crachá) em vez de users.numero_folha. Incluir ambos no match.
