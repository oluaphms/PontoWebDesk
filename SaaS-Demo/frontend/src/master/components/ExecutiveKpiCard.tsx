...
const TONE_CLASS: Record<Tone, string> = {
  ...
  teal: 'border-indigo-200 bg-indigo-50/80 shadow-sm dark:border-indigo-400/50 dark:bg-indigo-500/5',
  sky: 'border-sky-200 bg-sky-50/80 shadow-sm dark:border-sky-400/50 dark:bg-sky-500/5',
  amber: 'border-amber-200 bg-amber-50/80 shadow-sm dark:border-amber-400/50 dark:bg-amber-500/5',
  rose: 'border-rose-200 bg-rose-50/80 shadow-sm dark:border-rose-400/50 dark:bg-rose-500/5',
  violet: 'border-violet-200 bg-violet-50/80 shadow-sm dark:border-violet-400/50 dark:bg-violet-500/5',
  emerald: 'border-emerald-200 bg-emerald-50/80 shadow-sm dark:border-emerald-400/50 dark:bg-emerald-500/5',
};
